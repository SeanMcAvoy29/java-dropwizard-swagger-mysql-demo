...
public class EmployeeService
{
    public List<IPayable> getEmployees(){
        Employee employee = new Employee(1,"Sean", 50000);
        SalesEmployee salesEmployee = new SalesEmployee(1,"Tim",50000,500,0.01f);
        Contractor contractor = new Contractor("SM Digital",1000,10);
